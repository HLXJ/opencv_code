...
def getOrientation(pts, img):
    ...
    textbox = cv.rectangle(img, (cntr[0], cntr[1] - 25), (cntr[0] + 150, cntr[1] + 10), (255, 255, 255), -1)
    cv.putText(img, label, (cntr[0], cntr[1]), cv.FONT_HERSHEY_SIMPLEX, 0.3, (0, 0, 0), 1, cv.LINE_AA)

    return angle


# Load the image
img = cv.imread("pin_2.jpg")
