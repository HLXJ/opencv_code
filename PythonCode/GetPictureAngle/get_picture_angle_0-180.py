...
for i, c in enumerate(contours):
    ...
    textbox = cv.rectangle(img, (center[0] - 35, center[1] - 25),
                           (center[0] + 150, center[1] + 10), (255, 255, 255), -1) # 输入图像，左上角顶点，右下角顶点，边框颜色，线条粗细
    cv.putText(img, label, (center[0] - 50, center[1]),
               cv.FONT_HERSHEY_SIMPLEX, 0.4, (0, 0, 0), 1, cv.LINE_AA) # 输入图像，需要添加的文字，左上角坐标，字体类型，字体大小，文字颜色，字体粗细
